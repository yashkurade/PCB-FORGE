...
UPLOAD_FOLDER = '/home/yash/PCB_FORGE/Flask_v5/uploads'
...
def circle():
    ...
    image_dir = '/home/yash/PCB_FORGE/Flask_v5/inputs'
...
def detect_circle():
    if request.method == 'POST':
        ...
        image_path = f'/home/yash/PCB_FORGE/Flask_v5/inputs/{image_name}'
...
def detect_rectangle():
    image_name = request.form['imagePath']
    image_path = os.path.join('/home/yash/PCB_FORGE/Flask_v5/inputs', image_name)
